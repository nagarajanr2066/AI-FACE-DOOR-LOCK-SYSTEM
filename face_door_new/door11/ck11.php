...
window.location.href="ck11.php?id=<?php echo $id; ?>&act=ok";
</script>
<?php							
}
if(isset($btn2))
...
?>
<script language="javascript">
window.location.href="ck11.php?id=<?php echo $id; ?>&act=success";
</script>
<?php								
}
if($act=="4")
...
?>
                        ...
                        <div>
                            ...
                            <p align="center"><img src="upload/<?php echo $id; ?>.png" width="150" height="150" /></p>
							
							<p>
							<a href="ck11.php?act=1&id=<?php echo $id; ?>" class="tm-btn tm-btn-primary tm-btn-small">Open</a> /
							<a href="ck11.php?act=2&id=<?php echo $id; ?>" class="tm-btn tm-btn-primary tm-btn-small">Block</a>
							</p>
                            ...
                            <form method="post" name="form1" action="" class="mb-5 tm-comment-form">
								...
								<p>
							<a href="ck11.php?act=3&id=<?php echo $id; ?>" class="tm-btn tm-btn-primary tm-btn-small">Yes</a> /
							<a href="ck11.php?act=4&id=<?php echo $id; ?>" class="tm-btn tm-btn-primary tm-btn-small">No</a>
							</p>
								<?php
